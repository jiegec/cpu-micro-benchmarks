...
INSTR_TEST(int_add, "add.w $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_mul32, "mul.w $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_mul64, "mul.d $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_div64, "div.d $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_crc_w_d_w, "crc.w.d.w $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_crc_w_w_w, "crc.w.w.w $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_crcc_w_d_w, "crcc.w.d.w $r0, $r1, $r0\n", "r0")
INSTR_TEST(int_crcc_w_w_w, "crcc.w.w.w $r0, $r1, $r0\n", "r0")
INSTR_TEST(fp_fadd_single, "fadd.s $f0, $f1, $f0\n", "f0")
INSTR_TEST(fp_fadd_double, "fadd.d $f0, $f1, $f0\n", "f0")
INSTR_TEST(fp_fmul_single, "fmul.s $f0, $f1, $f0\n", "f0")
INSTR_TEST(fp_fmul_double, "fmul.d $f0, $f1, $f0\n", "f0")
INSTR_TEST(fp_fmadd3_single, "fmadd.s $f0, $f1, $f2, $f0\n", "f0")
INSTR_TEST(fp_fmadd3_double, "fmadd.d $f0, $f1, $f2, $f0\n", "f0")
INSTR_TEST(fp_fmadd2_single, "fmadd.s $f0, $f1, $f0, $f3\n", "f0")
INSTR_TEST(fp_fmadd2_double, "fmadd.d $f0, $f1, $f0, $f3\n", "f0")
INSTR_TEST(fp_fmadd1_single, "fmadd.s $f0, $f0, $f2, $f3\n", "f0")
INSTR_TEST(fp_fmadd1_double, "fmadd.d $f0, $f0, $f2, $f3\n", "f0")
INSTR_TEST(fp_fmadd_single, "fmadd.s $f0, $f1, $f2, $f3\n", "f0")
INSTR_TEST(fp_fmadd_double, "fmadd.d $f0, $f1, $f2, $f3\n", "f0")
#endif
