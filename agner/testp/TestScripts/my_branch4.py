...
for branch_toggle in x_data:
    ...
    for target_toggle in y_data:
        output = subprocess.check_output(
            ["./my_branch4.sh2", "16", "16", str(branch_toggle), str(target_toggle)], encoding="utf-8"
        )
        heading = False
        data = []
        ...
        # remove 500 mis-predictions in dummy branches
        avg = (np.average(np.array(data)) - 500) / 2000  # 2 branches, 1000 loops
